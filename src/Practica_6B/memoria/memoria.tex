...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=296,lastline=316, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=338,lastline=353, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=378,lastline=397, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=266,lastline=293, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=227,lastline=263, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=356,lastline=375, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=400,lastline=420, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=423,lastline=447, style=custompython]{../evaluation.py}
...
\begin{figure}[H]
    \centering
    \lstinputlisting[firstline=319,lastline=335, style=custompython]{../evaluation.py}
